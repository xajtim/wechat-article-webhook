        ...
        return res.send(`
          ...
          <body>
            <div class="box">
              ...
              <a href="/auth/password" class="btn btn-wework">🔑 密码登录</a>
              <div class="hint">手机微信内访问请点"微信登录"<br>PC 端访问请点"密码登录"</div>
            </div>
          </body>
          </html>
        `);
  ...
  res.send(`
    ...
    <body>
      <div class="box">
        ...
        <div class="hint"><a href="/" style="color:#576b95;text-decoration:none;">返回登录选择页</a></div>
      </div>
    </body></html>
  `);
});
